all: clean darwin linux test

clean:
	@echo "==> Cleaning up previous builds."
	@rm -rf ./bin/darwin/egolisp ./bin/linux/egolisp

linux:
	@env GOOS=linux go build -v -o ./bin/linux/egolisp  

darwin:
	@env GOOS=darwin go build -v -o ./bin/darwin/egolisp
...
race_compile:
	...
	@go build -v -race -o ./bin/egolisp $(shell go list ./... | grep -v /vendor/)
...
.PNONY: all clean deps fmt help test linux darwin
